...
$phoen_total_product_point_value = 0;
...
$phoen_rewpts_notification_checkout_page = isset($this->phoen_rewpts_notification_data['phoen_rewpts_notification_checkout_page'])?$this->phoen_rewpts_notification_data['phoen_rewpts_notification_checkout_page']:'You Will get {points} Points On Completing This Order';
...
$checkout_message = '<div class="alert hide" style="z-index: 999;top:8%;">';

$checkout_message .= '<span class="msg">'.str_replace("{points}","$phoen_total_product_point_value",$phoen_rewpts_notification_checkout_page).'</span></div>';

if( !empty($first_order_points_val) && $user_order_count == 0 && $enable_first_order_point == '1'){

	$checkout_message .= '<div class="alert hide" style="z-index: 999;top:17%;"><span class="msg">'.str_replace("{points}","$first_order_points_val",$phoen_rewpts_first_order_notification).'</span></div>';
}
